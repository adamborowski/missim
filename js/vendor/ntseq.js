...
var __4BitToNucleotide = (function () {
        var a = makeArray(16);
...
var __complementNucleotide = (function () {
...
export function MatchMap(query, searchSpace) {
...
MatchMap.prototype.__initialize = function () {
    ...
    this.__orderedResults = results.slice().sort(function (a, b) {
